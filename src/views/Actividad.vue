  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Desarrollo de aplicaciones móviles nativas
        p.mb-4 Vincular términos clave con sus definiciones apropiadas para reforzar el entendimiento del desarrollo de aplicaciones móviles nativas.
